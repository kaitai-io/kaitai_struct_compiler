...
trait CommonChecks extends LanguageCompiler with CommonReads {
  ...
  def attrCheck2(id: Identifier, dataType: DataType, repeat: RepeatSpec, shouldDependOnIo: Option[Boolean], exprTypeOpt: Option[DataType] = None): Unit
